...
detection_file = _input_path+_project+'/detectionTF16.csv'

video_path = _input_path+_project+'/data/'
video_format = 'avi'
frames_crop = None #_input_path+_project+'/vids_cropping.csv'
seq_len = 8
...
init_weights = None #_input_path+_project+'/features/pytorch/lstm_checkpoint.pth.tar'
